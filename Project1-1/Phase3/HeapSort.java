...
public class HeapSort
{
    ...
    public static void sort(GeneticAlgorithm.Individual i[])
    {
        int N = i.length;
        ...
        do
        {
            GeneticAlgorithm.Individual T = i[0];
            i[0] = i[N - 1];
            i[N - 1] = T;
    ...
    private static void downheap(GeneticAlgorithm.Individual i[], int k, int N)
    {
        GeneticAlgorithm.Individual T = i[k - 1];
