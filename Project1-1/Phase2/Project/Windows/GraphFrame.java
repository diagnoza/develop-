...
public class GraphFrame{
    public static final JButton[] colors = new JButton[20];
    ...
    public static void createWindow(){
        ...
        componentGraph = new GraphDisplay(true);
        ...
        colors[0].setBackground(new Color(230,25,75));
        colors[1].setBackground(new Color(60,180,75));
        colors[2].setBackground(new Color(255,225,25));
        colors[3].setBackground(new Color(0,130,200));
        colors[4].setBackground(new Color(245,130,48));
        colors[5].setBackground(new Color(145,30,180));
        colors[6].setBackground(new Color(70,240,240));
        colors[7].setBackground(new Color(240,50,230));
        colors[8].setBackground(new Color(210,245,60));
        colors[9].setBackground(new Color(250,190,190));
        colors[10].setBackground(new Color(0,128,128));
        colors[11].setBackground(new Color(230,190,255));
        colors[12].setBackground(new Color(170,110,40));
        colors[13].setBackground(new Color(255,250,200));
        colors[14].setBackground(new Color(128,0,0));
        colors[15].setBackground(new Color(170,255,195));
        colors[16].setBackground(new Color(128,128,0));
        colors[17].setBackground(new Color(255,215,180));
        colors[18].setBackground(new Color(0,0,128));
        colors[19].setBackground(new Color(128,128,0));
        for(int i=0;i<20;i++)
